...
export default function Navbar() {
    return (
        <header className="flex p-4 z-50 bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg justify-between items-center sticky top-0 py-4 md:py-8">
            {/* logo - start */}
            <Link to={"/"} aria-label="logo" className="inline-flex items-center text-black-800 text-indigo-600 text-2xl md:text-3xl font-bold gap-2.5">
